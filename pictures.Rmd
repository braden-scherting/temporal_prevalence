...
simplot1 <- ggplot() +
  ...
  geom_line(data=sim1[[5]], aes(x=t, y=y, color='True', linetype="True"), 
            size=.75) + 
  geom_line(data=sim1[[2]], aes(x=t, y=median, color='m=1*', linetype="m=1*"),
            size=.5) + 
  geom_line(data=sim1[[6]], aes(x=t, y=median, color='m=1', linetype="m=1"),
            size=.5) + 
  geom_line(data=sim1[[1]], aes(x=t, y=median, color='m=3', linetype="m=3"),
            size=.5) + 
...
simplot2 <- ggplot() +
  ...
  geom_line(data=sim2[[5]], aes(x=t, y=y, color='True', linetype="True"), 
            size=.75) + 
  geom_line(data=sim2[[2]], aes(x=t, y=median, color='m=1*', linetype="m=1*"),
            size=.5) + 
  geom_line(data=sim2[[6]], aes(x=t, y=median, color='m=1', linetype="m=1"),
            size=.5) + 
  geom_line(data=sim2[[1]], aes(x=t, y=median, color='m=10', linetype="m=10"),
            size=.5) + 
...
ggplot() + 
  ...
  geom_line(data=bat_limited, aes(x=dt, y=median, color='m=1*'), linetype=1, size=.75) + 
  geom_line(data=bat_5, aes(x=dt, y=median, color='m=5'), linetype=1, 
            size=.75) + 
  geom_line(data=bat_3, aes(x=dt, y=median, color='m=3'), linetype=1, 
            size=.75) + 
  geom_line(data=bat_all, aes(x=dt, y=median, color='m=1'), linetype=1, size=.75) +
...
nd_dat <- read_csv("my_data/ND_data.csv") %>% filter(surveil_total > 0) %>% mutate(dt = mdy(date))
...
ggplot() + 
  ...
  geom_ribbon(data=nd_all, aes(x=dt, ymin=lower, ymax=upper, fill='m=1'), 
              linetype=2, alpha=0.1, color='black', size=0.5) + 
  geom_line(data=nd_limited, aes(x=dt, y=median, color='m=1*')) + 
  geom_line(data=nd_5, aes(x=dt, y=median, color='m=5'), linetype=1, 
            size=.75) + 
  geom_line(data=nd_10, aes(x=dt, y=median, color='m=10'), linetype=1, 
            size=.75) + 
  geom_line(data=nd_all, aes(x=dt, y=median, color='m=1'), linetype=1, size=.75) + 
  geom_line(data=nd_limited, aes(x=dt, y=median, color='m=1*'), linetype=1, size=.75) + 
